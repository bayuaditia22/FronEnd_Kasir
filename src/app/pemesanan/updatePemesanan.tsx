...
const EditPemesanan = (pemesanan: Pemesanan) => {
  ...
  const [tanggal_pemesanan, setTanggalPemesanan] = useState(pemesanan.tanggal_pemesanan);
  ...
  const [jumlah_pelanggan, setJumlahPelanggan] = useState(pemesanan.jumlah_pelanggan);
